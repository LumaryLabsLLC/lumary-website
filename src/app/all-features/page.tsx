...
const featureCategories = [
  ...
  },
  {
    ...
    description: "Picture-in-picture in a single file",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    features: [
      ...
      },
      {
        ...
        description: "Drag to position or use presets. Bottom-right, bottom-left, top-right, top-left."
      },
      {
        name: "Camera Controls",
        description: "Horizontal and vertical flip. Border width, color, and shadow intensity controls."
      },
      {
        name: "Output Options",
        description: "Match source resolution or override to 1080p/720p. Frame rates up to 60fps."
      },
    ]
  },
  {
