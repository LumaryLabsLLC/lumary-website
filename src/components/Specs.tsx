          ...
          <div className="mt-20">
            ...
            <div className="max-w-lg mx-auto font-mono text-base">
              ...
              <div className="flex items-center gap-3 text-white">
                <svg className="w-6 h-6 text-zinc-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
              ...
              <div className="ml-3 mt-2 border-l-2 border-zinc-700 pl-6 space-y-4">
                ...
                <div>
                  <div className="flex items-center gap-3 text-white">
                    <svg className="w-5 h-5 text-zinc-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                      <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                    </svg>
                  ...
                  <div className="ml-2.5 mt-1 border-l-2 border-zinc-700/50 pl-5 space-y-2">
                    <div className="flex items-center gap-3 text-zinc-500 py-0.5">
                      <svg className="w-4 h-4 text-zinc-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
                ...
                <div className="flex items-center gap-3 text-zinc-500">
                  <svg className="w-5 h-5 text-zinc-600" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                  </svg>
