      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-4 flex-wrap">
            <span
              className="rounded-full bg-zinc-700 px-6 py-3 text-base font-semibold text-zinc-300 flex items-center gap-2 cursor-default"
            >
            ...
            <a
              href="#features"
              className="rounded-full px-6 py-3 text-base font-semibold text-white ring-1 ring-zinc-700 hover:ring-zinc-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
            >
              See Features
            </a>
          </div>
